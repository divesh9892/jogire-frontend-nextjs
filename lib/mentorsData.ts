export const mentorsData = {
  ...
  sections: [
    ...
    {
      id: "impact",
      heading: "Global Impact & Recognition",
      content: [
        {
          type: "paragraph",
          text: "Dr. Pandya has presented lectures and research across leading institutions such as the United Nations, University of Cambridge, IITs, IIMs, BARC, DRDO, and more. He has convened over 200 international and national colloquia, contributing to topics ranging from indigenous rights to Vedic science."
        },
        {
          type: "paragraph",
          text: "He has represented India at the UNESCO Inter-Governmental Meeting on Intangible Cultural Heritage and participated in the Inter-Parliamentary Conference on Interfaith Dialogue in Morocco."
        },
        {
          type: "heading",
          text: "Honors & Awards:"
