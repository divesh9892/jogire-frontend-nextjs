...
export const metadata: Metadata = {
  ...
  description:
    "Experience the perfect blend of ancient yogic wisdom, modern psychology, and clinical science tailored for your physical and mental growth.",
  keywords: [
    "Yoga",
    "Wellness",
    "Holistic Health",
  ...
  openGraph: {
    title: "Jogire | Holistic Health & Wellness Studio",
    description:
      "Experience the perfect blend of ancient yogic wisdom and modern wellness tailored for your growth.",
    type: "website",
    locale: "en_IN",
    siteName: "Jogire",
  },
    ...
    <ClerkProvider>
      ...
      >
        <body
          ...
          className="bg-studio-bg text-studio-text selection:bg-studio-primary/20 selection:text-studio-primary flex min-h-full flex-col overflow-x-hidden"
        >
          <ServerWakeup />
          {/* Main Content Area */}
